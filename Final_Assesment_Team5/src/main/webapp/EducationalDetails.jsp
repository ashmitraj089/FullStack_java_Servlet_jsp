				...
				<div class="container">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="nav nav-tabs ml-auto">
							  <li class="nav-item">
							    <a class="nav-link" href="EmpDetails.jsp"><strong>Personal Details</strong></a>
							  </li>
							  <li class="nav-item">
						...
						<form action="EducationalDetails" method="post">
							<div class="form-row">
								...
								<div class="form-group col-md-12 mb-2">
									...
									<input type="text" class="form-control" id="XII" name ="SS"
							...
							<div class="form-row">
								...
								<div class="form-group col-md-6 mb-2">
									...
									<input type="text" class="form-control" id="MTech" name="MTech"
										placeholder="Enter Marks(CGPA / %) or 0" type="text"
										>
								</div>
							</div>
							...
							<div class="form-row">
								...
								<a href="AutopopulateEdu"  class="btn info_btn">Edit</a> 
							</div>
						</form>
					</div>
				</div>
