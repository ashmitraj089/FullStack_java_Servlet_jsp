					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav ml-auto">
							<li class="nav-item active"><a class="nav-link"
								href="register.jsp"><strong class="side_button">Sign Up</strong> <span class="sr-only">(current)</span></a>
							</li>
						</ul>
					</div>
				</div>
						...
						<div class="d-flex justify-content-center form_container">
							<form action="Login" method="post">
								<div class="input-group mb-3">
									...
									<input type="text" name="UserName" id="UserName" onchange="check()" minlength=3 maxlength=50
								...
								<div class="d-flex justify-content-center mt-3 login_container">
									<input type="submit" id="mybtn" value="Login" class="btn login_btn" disabled/>
								</div>
							</form>
						</div>
