...
<link rel="icon"
	...
	type="image/x-icon">
<style>
<%@ include file="EmpDetailsEdit.css"%>
</style>
<link rel="stylesheet"
			...
			<div class="container main_body">
				<div class="row">
					...
					<div class=" side2 col-md-8 py-5 border">
						...
						<form action="EmpDetailsEdit" method="post">
							<div class="form-row">
								<div class="input-group col-md-6 mb-2">
									<div class="input-group-append">
										<span class="input-group-text"><i class="fas fa-user"></i></span>
									</div>
									<input id="FirstName" name="FirstName" placeholder="First Name" value=<%=session.getAttribute("v1") %>
								...
								<div class="input-group col-md-6 mb-2">
									...
									<input type="text" class="form-control" id="LastName" name="LastName" value=<%=session.getAttribute("v2") %>
							...
							<div class="form-row">
								<div class="input-group col-md-6 mb-2">
									...
									<input id="Email" name="Email" placeholder="Email" value=<%=session.getAttribute("v3") %>
								...
								<div class="input-group col-md-6 mb-2">
									...
									<input type="text" class="form-control" id="Phone" name="Phone" value=<%=session.getAttribute("v4") %>
										placeholder="Phone">
								</div>
							</div>
							<div class="form-row">
								<div class="input-group col-md-12 mb-2">
									...
									<input id="Date" name="Date" placeholder="Joining Date" value=<%=session.getAttribute("v5") %>
							...
							<div class="form-row mb-2">
								<div class="input-group col-md-12 mb-2">
									...
									<textarea class="form-control form-control-lg" placeholder="Permanent Address" id="address" name="address" 
										type="text" rows="2" cols="10"  required/><%=session.getAttribute("v6") %></textarea><br>
								</div>
							</div>
							<div class="form-row mb-2">
								<div class="input-group col-md-12 mb-2">
